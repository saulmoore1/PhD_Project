...
various strains of E. coli cultered from the gut microbiomes of various animals,
and compared to N2 performance on standard laboratory E. coli strain, OP50, as 
the control. 
...
sys.path.insert(1, '/Users/sm5911/OneDrive - Imperial College London/PanGenome/Code/')
