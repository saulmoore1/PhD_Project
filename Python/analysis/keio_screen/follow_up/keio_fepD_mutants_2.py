...
# -*- coding: utf-8 -*-
"""
Keio fepD mutants 2 - analyse repeat of fepD mutants (fecA/gltA/tonB/)
...
PROJECT_DIR = "/Volumes/hermes$/Saul/Keio_Screen/Data/Keio_FepD_Mutants_2"
SAVE_DIR = "/Users/sm5911/Documents/Keio_FepD_Mutants_2"
N_WELLS = 6
...
WINDOW_DICT = {0: (290,300)} # arousal window 20-30 seconds after final blue light pulse
...
def main():
    ...
    plt.savefig(Path(SAVE_DIR) / 'Plots' / 'speed_50th_vs_{}.png'.format(control), dpi=DPI)  
