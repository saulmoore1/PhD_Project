...
def main():
    ...
    if not metadata_path_local.exists() or not features_path_local.exists():
        ...
        # HACK - CRASHES WHEN COMPILING METADATA AS SOME EXPECTED VIDEOS ARE MISSING DUE TO ERROR 
        #        WHEN RECORDING WITH HYDRA - THESE VIDEOS WERE NOT PROCESSED WITH TIERPSY AND DO NOT
        #        HAVE RESULTS. I MANUALLY DELETED THE ROWS FROM DAY METADATA WITH MISSING DATA FOR 
        #        IMGSTORE_NAME TO REMOVE ENTRIES FOR MISSING VIDEOS THEN RE-RAN THE COMPILE_METADATA 
        #        FUNCTION BELOW
