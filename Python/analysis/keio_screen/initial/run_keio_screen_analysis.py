...
# -*- coding: utf-8 -*-
"""
Analyse Keio initial and confirmation screen results and identify hit strains as eliciting a 
significant difference in worm behaviour relative to control N2 worms on BW wild-type background
...
#!!! Threshold max distance of 8 used for final clustering analysis (Tierpsy16, fdr_bh, all strains)
