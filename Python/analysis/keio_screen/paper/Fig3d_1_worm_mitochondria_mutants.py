...
SAVE_DIR = '/Users/sm5911/Documents/PhD_DLBG/Fig3d_1 worm mitochondria mutants'
...
def main():
    ...
    plot_df.to_csv(Path(SAVE_DIR) / 'Fig3d_1_data.csv', header=True, index=False)
    ...
    boxplot_path = Path(SAVE_DIR) / 'Fig3d_1_worm_mitochondria_mutants.svg'
