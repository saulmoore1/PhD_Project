...
SAVE_DIR = "/Users/sm5911/Documents/PhD_DLBG/FigS3i worm hsp-6 and mev-1 mutants paraquat"
...
def main():
    ...
    plot_df.to_csv(Path(SAVE_DIR) / 'FigS3i_data.csv', header=True, index=False)

    # stats vs BW-Paraquat
    ...
    boxplot_path = Path(SAVE_DIR) / 'FigS3i_worm_hsp-6_and_mev-1_mutants_paraquat.svg'
