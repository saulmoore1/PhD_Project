...
preliminary screening of bacterial strains previously reported
...
# Filter for data for bacterial strains that are NOT part of the microbiome 'core set'
...
for test in tests:
    ...
    stats_outpath = os.path.join(PROJECT_ROOT_DIR, 'Results', 'Bacterial_Strains', 'Stats', 'L4_snippet_1',\
                                 test_name, test_name + '_results.csv')
    sigfeats_outpath = os.path.join(PROJECT_ROOT_DIR, 'Results', 'Bacterial_Strains', 'Stats', 'L4_snippet_1',\
...
for test_name in test_names:
    ...
    test_inpath = os.path.join(PROJECT_ROOT_DIR, 'Results', 'Bacterial_Strains', 'Stats', 'L4_snippet_1',\
                               test_name, test_name + '_results.csv')
    ...
    for f, feature in enumerate(features2plot):
        ...
        plotpath_out = os.path.join(PROJECT_ROOT_DIR, "Results", "Bacterial_Strains", "Plots", "L4_snippet_1", "All", "Top256_Javer_2018",\
...
for test_name in test_names:
    ...
    test_results_inpath = os.path.join(PROJECT_ROOT_DIR, 'Results', 'Bacterial_Strains', 'Stats', 'L4_snippet_1',\
                                       test_name, test_name + '_results.csv')
    ...
    for i, food in enumerate(test_pvalues_df.index.str.upper()):
        ...
        if pvals.isna().all():
            ...
            for f, feature in enumerate(topfeats.index):
                ...
                # Save figure
                plots_outpath = os.path.join(PROJECT_ROOT_DIR, 'Results', 'Bacterial_Strains', 'Plots', 'L4_snippet_1', food,\
...
plotroot = os.path.join(PROJECT_ROOT_DIR, 'Results', 'Bacterial_Strains', 'Plots', 'L4_snippet_1', 'All', 'HCA')
...
for test_name in test_names:
    # Read test results (pvalues)
    results_inPath = os.path.join(PROJECT_ROOT_DIR, 'Results', 'Bacterial_Strains', 'Stats', 'L4_snippet_1',\
                                  test_name, test_name + '_results.csv')
    test_pvalues_df = pd.read_csv(results_inPath, index_col=0)
    
    # Read significant features list for each food
    sigfeats_in = os.path.join(PROJECT_ROOT_DIR, 'Results', 'Bacterial_Strains', 'Stats', 'L4_snippet_1',\
                               test_name, test_name + '_significant_features.csv')
...
tic = time.time()
plotroot = os.path.join(PROJECT_ROOT_DIR, 'Results', 'Bacterial_Strains', 'Plots', 'L4_snippet_1', 'All', 'PCA')
...
plotroot = os.path.join(PROJECT_ROOT_DIR, 'Results', 'Bacterial_Strains', 'Plots', 'L4_snippet_1', 'All', 'tSNE')
...
plotroot = os.path.join(PROJECT_ROOT_DIR, 'Results', 'Bacterial_Strains', 'Plots', 'L4_snippet_1', 'All', 'UMAP')
