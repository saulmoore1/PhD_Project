...
from food_choice.SM_read import getauxinfo
from manual_labelling.label_lawns import manuallabelling
from visualisation.well_trajectories import plot_worm_trajectories
...
for i, filepath in enumerate(metaData['filename']): 
    ...
    aux_info = getauxinfo(maskedvideopath=filepath, sheet=0)
...
for i, maskedfilepath in enumerate(fullMetaData['filename']):    
    ...
    plot_worm_trajectories(maskedfilepath, downsample=10, save=True, skip=True)
