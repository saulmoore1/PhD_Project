...
PROJECT_DIR = "/Users/sm5911/Documents/Keio_Deferoxamine"
...
def main():
    ...
    order = ['none', 'deferoxamine-0.5', 'deferoxamine-1', 'deferoxamine-5']
    ...
    plt.savefig(Path(SAVE_DIR) / 'Fig3e.png', dpi=DPI)  
